...
public class PurchaseResult extends FrontendForm {
    ...
    public PurchaseResult(final String paymentTransactionExternalKey, final Exception e){
        this(Optional.<PaymentServiceProviderResult>absent(),
             ...
             null,
             null,
             ImmutableMap.<String, String>of("Exception", e.getMessage()));
    }


    public PurchaseResult(final String paymentTransactionExternalKey, final IOException e){
        this(Optional.<PaymentServiceProviderResult>absent(),
             null,
             null,
             null,
             ...
             null,
             null,
             ImmutableMap.<String, String>of("IOException", e.getMessage()));
    }

    public PurchaseResult (final String paymentTransactionExternalKey, final ApiException e){
        this(Optional.<PaymentServiceProviderResult>absent(),
             null,
             null,
             null,
             ...
             null,
             null,
             ImmutableMap.<String, String>of(ADYEN_CALL_ERROR_STATUS, String.valueOf(e.getError().getStatus()),
                                                                         EXCEPTION_CLASS, e.getError().getErrorType(),
                                                                         EXCEPTION_ERROR_CODE, e.getError().getErrorCode(),
                                                                         EXCEPTION_MESSAGE, e.getError().getMessage()));
    }
