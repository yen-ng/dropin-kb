...
import static org.killbill.billing.plugin.adyen.api.AdyenPaymentPluginApi.PROPERTY_DROPIN_DATA;
...
public abstract class CardMappingService {
    ...
    public static Card toPaymentInfo(final AdyenPaymentMethodsRecord paymentMethodsRecord, final Iterable<PluginProperty> properties) {
        ...
        final String dropinData= PluginProperties.findAndDecodePluginPropertyValue(PROPERTY_DROPIN_DATA,properties);
        if(dropinData != null){
            card.setDropinData(dropinData);
        }
